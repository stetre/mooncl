...
[small]#Rfr: https://www.khronos.org/registry/OpenCL/sdk/2.1/docs/man/xhtml/clCreatePipe.html[clCreatePipe].#

[[retain_pipe]]
* *retain_pipe*(_pipe_) +
*release_pipe*(_pipe_) +
[small]#Rfr: https://www.khronos.org/registry/OpenCL/sdk/2.1/docs/man/xhtml/clRetainPipe.html[clRetainPipe] - 
https://www.khronos.org/registry/OpenCL/sdk/2.1/docs/man/xhtml/clReleasePipe.html[clReleasePipe].#
